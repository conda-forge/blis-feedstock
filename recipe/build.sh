...
case $target_platform in
    ...
    win-*)
        ...
        clang-cl -I$PREFIX\Library\include\blis /FAcs -o bli_gemm_ker_var2.s frame/3/gemm/bli_gemm_ker_var2.c
        ...
        clang-cl -I$PREFIX\Library\include\blis /FAcs -o bli_dgemm_skx_asm_16x14.s kernels/skx/3/bli_dgemm_skx_asm_16x14.c
